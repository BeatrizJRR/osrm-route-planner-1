 ...
 * - Camada API (infra): encapsula chamadas HTTP externas e fornece dados brutos.
 * - Consumido pela camada Service (Controller) que orquestra lógica de negócio.
 * - Model recebe/representa os dados parseados; UI não deve chamar este cliente diretamente.
 *
 * Endpoint utilizado:
