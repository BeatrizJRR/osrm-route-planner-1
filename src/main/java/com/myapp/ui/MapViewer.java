 ...
 * - View (UI): apresenta mapa interativo, formulários e controlos ao
 * utilizador.
 * - Consome Service (Controller) para obter rotas, POIs, geocodificação e
 * elevação.
 * - Renderiza modelos (Route, Point, POI) no mapa; não contém lógica de
 * negócio.
 *
